...
get_header();
?>
<div class="over-ons-hero-container">
    <div class="over-ons-hero-overlay-container">
        <h1 class="over-ons-hero-title">Over ons</h1>
        <p class="over-ons-hero-text">Timeless Wood heeft een team van ervaren mensen achter zich staan, dat met passie en vakmanschap alle houtconstructies bouwt volledig naar de wensen van de klant. Streven naar volledige klantentevredenheid is onze grootste drijfveer.</p>
        <a href="#" class="over-ons-hero-btn">Ontdek ons team</a>
    </div>
</div>
<hr id="over-ons-hero-line-vert">
...
<div class="over-ons-team-container">
    <div class="over-ons-team-title-container">
        <h2 class="over-ons-team-title">Ontmoet het team</h2>
    </div>
    <div class="over-ons-team-text-foto-container">
        <div class="over-ons-team-text-container">
...
<div class="over-ons-werken-container">
