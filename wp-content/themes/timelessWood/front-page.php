...
<div class="slogan-section">
    ...
    <div class="slogan-text-container">
        ...
        <p class="slogan-text">Timeless Wood heeft een team van ervaren mensen achter zich staan, dat met passie en vakmanschap alle houtconstructies bouwt volledig naar de wensen van de klant. Streven naar volledige klantentevredenheid is onze grootste drijfveer.</p>
        <a href="#" class="slogan-button">Meer over ons</a>
    </div>
</div>
